...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default=os.path.join(current_dir, 'model', 'best.pth'), help='model.pt path(s)')  
    parser.add_argument('--image_path', type=str, default=os.path.join(current_dir, 'source'), help='source')
